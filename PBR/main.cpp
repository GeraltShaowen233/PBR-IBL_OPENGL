...
int main(int argc, char* argv[])
{
    ...
    Shader ToCubemap("ToCubemap.vert", "ToCubemap.frag");
    Shader Background("Background.vert", "Background.frag");
    Shader irradianceShader("ToCubemap.vert", "irradiance.frag");
    ...
    float* data = stbi_loadf((exePath+"\\hdr\\Newport_Loft.hdr").c_str(), &width, &height, &nrComponents, 0);
